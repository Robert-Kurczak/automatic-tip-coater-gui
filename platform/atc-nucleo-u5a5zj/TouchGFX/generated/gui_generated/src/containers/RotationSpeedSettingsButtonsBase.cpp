...
/*********************************************************************************/
#include <gui_generated/containers/RotationSpeedSettingsButtonsBase.hpp>
#include <touchgfx/Color.hpp>
#include <texts/TextKeysAndLanguages.hpp>
#include <images/BitmapDatabase.hpp>

RotationSpeedSettingsButtonsBase::RotationSpeedSettingsButtonsBase() :
    speedButtonPressedCallback(0),
    directionButtonPressedCallback(0),
    rotationTimeButtonPressedCallback(0),
    flexButtonCallback(this, &RotationSpeedSettingsButtonsBase::flexButtonCallbackHandler)
{
    setWidth(480);
    setHeight(245);
    ...
    rotationTimeButton.setText(TypedText(T___SINGLEUSE_QWR3));
    ...
    directionButton.setText(TypedText(T___SINGLEUSE_LNO1));
    ...
    speedButtonContainer.setPosition(0, 0, 162, 165);
    speedButtonShadow.setPosition(0, 0, 162, 165);
    ...
    speedButton.setIconXY(50, 20);
    speedButton.setText(TypedText(T___SINGLEUSE_6Y41));
...
void RotationSpeedSettingsButtonsBase::initialize()
{

}

void RotationSpeedSettingsButtonsBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &speedButton)
    {
        //SpeedButtonPressed
