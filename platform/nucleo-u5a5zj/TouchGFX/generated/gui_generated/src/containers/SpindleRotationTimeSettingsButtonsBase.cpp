...
/*********************************************************************************/
#include <gui_generated/containers/SpindleRotationTimeSettingsButtonsBase.hpp>
#include <touchgfx/Color.hpp>
#include <images/BitmapDatabase.hpp>
#include <texts/TextKeysAndLanguages.hpp>

SpindleRotationTimeSettingsButtonsBase::SpindleRotationTimeSettingsButtonsBase() :
    speedButtonPressedCallback(0),
    directionButtonPressedCallback(0),
    rotationTimeButtonPressedCallback(0),
    flexButtonCallback(this, &SpindleRotationTimeSettingsButtonsBase::flexButtonCallbackHandler)
{
    setWidth(480);
    setHeight(245);
...
void SpindleRotationTimeSettingsButtonsBase::initialize()
{

}

void SpindleRotationTimeSettingsButtonsBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &speedButton)
    {
        //SpeedButtonPressed
