...
SpindleDirectionSelectorBase::SpindleDirectionSelectorBase() :
    ClockwiseButtonPressedCallback(0),
    CounterClockwiseButtonPressedCallback(0),
    flexButtonCallback(this, &SpindleDirectionSelectorBase::flexButtonCallbackHandler)
{
    setWidth(480);
    setHeight(800);
...
void SpindleDirectionSelectorBase::initialize()
{

}

void SpindleDirectionSelectorBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
