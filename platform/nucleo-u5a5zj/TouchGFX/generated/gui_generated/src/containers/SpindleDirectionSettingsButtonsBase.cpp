...
/*********************************************************************************/
#include <gui_generated/containers/SpindleDirectionSettingsButtonsBase.hpp>
#include <touchgfx/Color.hpp>
#include <texts/TextKeysAndLanguages.hpp>
#include <images/BitmapDatabase.hpp>

SpindleDirectionSettingsButtonsBase::SpindleDirectionSettingsButtonsBase() :
    speedButtonPressedCallback(0),
    directionButtonPressedCallback(0),
    rotationTimeButtonPressedCallback(0),
    flexButtonCallback(this, &SpindleDirectionSettingsButtonsBase::flexButtonCallbackHandler)
{
    setWidth(480);
    setHeight(245);
...
void SpindleDirectionSettingsButtonsBase::initialize()
{

}

void SpindleDirectionSettingsButtonsBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &speedButton)
    {
        //SpeedButtonPressed
