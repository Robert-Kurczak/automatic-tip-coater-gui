...
/*********************************************************************************/
#include <gui_generated/containers/SpindleSpeedSettingsButtonsBase.hpp>
#include <touchgfx/Color.hpp>
#include <texts/TextKeysAndLanguages.hpp>
#include <images/BitmapDatabase.hpp>

SpindleSpeedSettingsButtonsBase::SpindleSpeedSettingsButtonsBase() :
    speedButtonPressedCallback(0),
    directionButtonPressedCallback(0),
    rotationTimeButtonPressedCallback(0),
    flexButtonCallback(this, &SpindleSpeedSettingsButtonsBase::flexButtonCallbackHandler)
{
    setWidth(480);
    setHeight(245);
...
void SpindleSpeedSettingsButtonsBase::initialize()
{

}

void SpindleSpeedSettingsButtonsBase::flexButtonCallbackHandler(const touchgfx::AbstractButtonContainer& src)
{
    if (&src == &speedButton)
    {
        //SpeedButtonPressed
