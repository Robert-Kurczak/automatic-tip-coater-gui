...
class ZAxisTestScreenView;

class ZAxisTestScreenPresenter :
    public touchgfx::Presenter,
    public ModelListener {
public:
    ZAxisTestScreenPresenter(ZAxisTestScreenView& v);
    ...
    virtual ~ZAxisTestScreenPresenter() {}
...
private:
    ZAxisTestScreenPresenter();

    ZAxisTestScreenView& view;
};
